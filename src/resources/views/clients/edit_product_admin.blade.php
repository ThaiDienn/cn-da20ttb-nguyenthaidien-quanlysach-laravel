...
<h1 class="mg">Cập nhật sản phẩm</h1>
<hr>
    ...
    <div class="row mg">
        ...
        <div class="col-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="name" placeholder="Tên sản phẩm" value="{{$product->tensach}}">
                @if ($errors->has('name'))
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="tacgia" placeholder="Tác giả" value="{{$product->tacgia}}">
            ...
            <div class="mb-3">
                <select class="form-control" name="maloai">
                    ...
                    @if($maloai == 1)
                    <option value="1" selected>Văn học</option>
                    ...
                    <option value="1">Văn học</option>
                    <option value="2">Lịch sử</option>
                    <option value="3" selected>Kinh tế</option>
                    <option value="4">Toán học</option>
                    <option value="5">Tiểu thuyết</option>
                    <option value="6">Tiếng anh</option>
                    ...
                    <option value="2">Lịch sử</option>
                    <option value="3">Kinh tế</option>
                    <option value="4" selected>Toán học</option>
                    <option value="5">Tiểu thuyết</option>
                    <option value="6">Tiếng anh</option>
                    ...
                    <option value="3">Kinh tế</option>
                    <option value="4">Toán học</option>
                    <option value="5" selected>Tiểu thuyết</option>
                    <option value="6">Tiếng anh</option>
                    ...
                    <option value="4">Toán học</option>
                    <option value="5">Tiểu thuyết</option>
                    <option value="6" selected>Tiếng anh</option>
                    @endif
            ...
            <div class="mb-3">
                ...
                <select name="status" class="form-control" id="tinhtrang">
                    <!-- <option value="" {{old('status')==0?'selected':false}}>Còn</option>
                    ...
                    @if($tinhtrang == 0)
                    <option value="0" selected>Còn</option>
                    <option value="1">Hết</option>

                    @elseif($tinhtrang == 1)
                    <option value="0">Còn</option>
                    <option value="1" selected>Hết</option>
                    @endif
            ...
            <div class="mb-3">
                ...
                <input type="file" name="file" id="fileInput" value="{{$product->hinhsach}}" onchange="previewImage()">
            </div>
        </div>
        <div class="col-6 center">
            <a id="imageLink" class="a" style="display: none;">Ảnh minh họa</a>
            <!-- Thêm một thẻ img để hiển thị ảnh xem trước -->
            <img id="preview" src="../uploads/product/{{$product->hinhsach}}" alt="Ảnh xem trước" style="display: block; margin-top: 20px; width: 300px; height: 400px; margin-left:200px">
        </div>
