...
<div class="container-sm">
   ...
   <div class="row">
      @foreach($product_by_category_id as $key => $product)
      <div class="col-3 gallery">
         <a href="{{URL::to('/chi-tiet-san-pham/'.$product->product_id)}}" target="_blank"><img src="../uploads/product/{{$product->hinhsach}}" alt=""></a>
