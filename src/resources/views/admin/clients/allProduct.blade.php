...
<a href="{{route('product')}}" class="btn btn-warning">Quay lại</a>
<hr>
...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{$item->ngaythem}}</td>
            <td>
                <a href="{{ route('getproduct', ['id'=>$item->id] ) }}" class="btn btn-warning btn-sm">Sửa</a>
            </td>
            <td>
                <a onclick="return confirm('Bạn có chắc chắn muốn xóa?')"
                    href="{{ route('delete', ['id'=>$item->id] ) }}" class="btn btn-danger btn-sm">Xóa</a>
            </td>
        </tr>
        @endforeach
        @else
