...
<form action="{{ route('postproduct') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="row mg">
        <div class="col-6">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="product_name" placeholder="Tác giả"
                    value="{{old('product_name')}}">
                @if ($errors->has('email'))
        ...
        <div class="col-6 center">
            ...
            <img id="preview" src="" alt="Ảnh xem trước"
                style="display: none; margin-top: 20px; width: 300px; height: 400px; margin-left:200px">
        </div>
    ...
    <button type="submit" class="btn btn-primary mg">Thêm sản phẩm</button>
</form>
@endsection
